...
Node-by-node walkthrough of [`workflows/ai-executive-summarizer.json`](../workflows/ai-executive-summarizer.json), including the failure paths.
...
Full system prompt and output contract: [`prompts/executive-summary.md`](../prompts/executive-summary.md)
