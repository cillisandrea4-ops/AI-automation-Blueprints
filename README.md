...
I file blueprint pronti da importare su n8n sono disponibili direttamente nella root di questa repository:
- `ai-executive-summarizer.json`
- `ai-lead-scoring-agent.json`
